...
SKILL_DIR="${CLAUDE_CONFIG_DIR:-${XIAOMEI_CLAUDE_CONFIG_DIR:-~/.claude}}/skills/meituan-coupon-traffic"
...
领券成功后，兑换码自动保存至：`~/.xiaomei-workspace/skills_local_cache/meituan-coupon-traffic/data/mt_ods_coupon_history.json`
